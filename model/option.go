...
func InitOptionMap() {
	...
	common.OptionMap["LogChatContentMaxBytes"] = strconv.Itoa(common.EffectiveLogChatContentMaxBytes())
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "LogChatContentMaxBytes":
		if intValue, parseErr := strconv.Atoi(value); parseErr == nil && intValue > 0 {
			common.LogChatContentMaxBytes = intValue
		} else {
